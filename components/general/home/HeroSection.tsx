...
export function HeroSection() {
    return(
        ...
        <h1 className="text-5xl w-lg lg:w-xl font-bold text-center">Yeni, Güvenli ve Profosyonel <span className="text-green-500 dark:text-green-400 p-1">Sosyal Medya</span></h1>
